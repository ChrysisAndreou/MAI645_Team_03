...
class acLSTM(nn.Module):
    ...
    def forward(self, initial_seq_processed_lstm, generate_frames_number):
        batch = initial_seq_processed_lstm.size(0) 
    ...
    for b in range(batch_size):
        ...
        try:
            if hasattr(read_bvh, 'write_frames'): 
                ...
                raise AttributeError("The BVH writing function 'write_frames' was not found in read_bvh.py.")
        ...
        if full_ground_truth_for_bvh_np is not None and b < full_ground_truth_for_bvh_np.shape[0]:
            ...
            try:
                if hasattr(read_bvh, 'write_frames'):
                    ...
                    raise AttributeError("The BVH writing function 'write_frames' was not found in read_bvh.py for GT.")
